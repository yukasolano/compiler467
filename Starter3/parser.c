...
/* Line 1806 of yacc.c  */
#line 160 "parser.y"
    { yTRACE("declaration -> type ID ;\n") ; (yyval.as_ast) = ast_allocate(DECLARATION_NODE, (yyvsp[(1) - (3)].as_ast), (yyvsp[(2) - (3)].as_str), NULL);}
    break;
...
/* Line 1806 of yacc.c  */
#line 162 "parser.y"
    { yTRACE("declaration -> type ID = expression ;\n"); (yyval.as_ast) = ast_allocate(DECLARATION_NODE, (yyvsp[(1) - (5)].as_ast), (yyvsp[(2) - (5)].as_str), (yyvsp[(4) - (5)].as_ast)); }
    break;
...
/* Line 1806 of yacc.c  */
#line 164 "parser.y"
    { yTRACE("declaration -> CONST type ID = expression ;\n"); (yyval.as_ast) = ast_allocate(DECLARATION_NODE, (yyvsp[(2) - (6)].as_ast), (yyvsp[(3) - (6)].as_str), (yyvsp[(5) - (6)].as_ast)); }
    break;
...
/* Line 1806 of yacc.c  */
#line 184 "parser.y"
    { yTRACE("type -> IVEC_T \n"); (yyval.as_ast) = ast_allocate(TYPE_NODE, "ivec"); }
    break;
...
/* Line 1806 of yacc.c  */
#line 188 "parser.y"
    { yTRACE("type -> BVEC_T \n"); (yyval.as_ast) = ast_allocate(TYPE_NODE, "bvec"); }
    break;
...
/* Line 1806 of yacc.c  */
#line 192 "parser.y"
    { yTRACE("type -> VEC_T \n"); (yyval.as_ast) = ast_allocate(TYPE_NODE, "vec"); }
    break;
